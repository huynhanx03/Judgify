...
func (_d *RankDelete) Where(ps ...predicate.Rank) *RankDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *RankDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *RankDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *RankDelete) sqlExec(ctx context.Context) (int, error) {
...
// Where appends a list predicates to the RankDelete builder.
func (_d *RankDeleteOne) Where(ps ...predicate.Rank) *RankDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *RankDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *RankDeleteOne) ExecX(ctx context.Context) {
