...
func (_q *LevelQuery) ForUpdate(opts ...sql.LockOption) *LevelQuery {
...
func (_q *LevelQuery) ForShare(opts ...sql.LockOption) *LevelQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
func (_q *LevelQuery) Modify(modifiers ...func(s *sql.Selector)) *LevelSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *LevelSelect) Modify(modifiers ...func(s *sql.Selector)) *LevelSelect {
