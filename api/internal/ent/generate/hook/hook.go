...
type ProblemFunc func(context.Context, *generate.ProblemMutation) (generate.Value, error)

// Mutate calls f(ctx, m).
func (f ProblemFunc) Mutate(ctx context.Context, m generate.Mutation) (generate.Value, error) {
	if mv, ok := m.(*generate.ProblemMutation); ok {
		return f(ctx, mv)
	}
...
// Mutate calls f(ctx, m).
func (f TagFunc) Mutate(ctx context.Context, m generate.Mutation) (generate.Value, error) {
	if mv, ok := m.(*generate.TagMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generate.TagMutation", m)
}

// The TestCaseFunc type is an adapter to allow the use of ordinary
// function as TestCase mutator.
type TestCaseFunc func(context.Context, *generate.TestCaseMutation) (generate.Value, error)

// Mutate calls f(ctx, m).
func (f TestCaseFunc) Mutate(ctx context.Context, m generate.Mutation) (generate.Value, error) {
	if mv, ok := m.(*generate.TestCaseMutation); ok {
		return f(ctx, mv)
	}
