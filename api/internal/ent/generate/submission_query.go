...
func (_q *SubmissionQuery) QueryProblem() *ProblemQuery {
...
func (_q *SubmissionQuery) QueryContest() *ContestQuery {
...
func (_q *SubmissionQuery) WithProblem(opts ...func(*ProblemQuery)) *SubmissionQuery {
	query := (&ProblemClient{config: _q.config}).Query()
...
func (_q *SubmissionQuery) WithContest(opts ...func(*ContestQuery)) *SubmissionQuery {
	query := (&ContestClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *SubmissionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Submission, error) {
	...
	if query := _q.withContest; query != nil {
		if err := _q.loadContest(ctx, query, nodes, nil,
			func(n *Submission, e *Contest) { n.Edges.Contest = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *SubmissionQuery) loadProblem(ctx context.Context, query *ProblemQuery, nodes []*Submission, init func(*Submission), assign func(*Submission, *Problem)) error {
...
func (_q *SubmissionQuery) loadContest(ctx context.Context, query *ContestQuery, nodes []*Submission, init func(*Submission), assign func(*Submission, *Contest)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Submission)
	for i := range nodes {
		if nodes[i].ContestID == nil {
			continue
		}
...
func (_q *SubmissionQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withContest != nil {
			_spec.Node.AddColumnOnce(submission.FieldContestID)
		}
	}
...
func (_q *SubmissionQuery) ForUpdate(opts ...sql.LockOption) *SubmissionQuery {
...
func (_q *SubmissionQuery) ForShare(opts ...sql.LockOption) *SubmissionQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
func (_q *SubmissionQuery) Modify(modifiers ...func(s *sql.Selector)) *SubmissionSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *SubmissionSelect) Modify(modifiers ...func(s *sql.Selector)) *SubmissionSelect {
