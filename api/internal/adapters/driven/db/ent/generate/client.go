...
import (
	...
	"github.com/huynhanx03/judgify/internal/adapters/driven/db/ent/generate/migrate"
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.Resource, c.Role, c.User, c.UserAttributeValue,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		AttributeDefinition, Credential, FederatedIdentity, Permission, Resource, Role,
		User, UserAttributeValue []ent.Hook
	}
	inters struct {
		AttributeDefinition, Credential, FederatedIdentity, Permission, Resource, Role,
		User, UserAttributeValue []ent.Interceptor
	}
)
