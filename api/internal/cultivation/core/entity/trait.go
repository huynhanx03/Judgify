...
// TraitWithWeight is a Trait with its rarity weight for gacha calculations.
type TraitWithWeight struct {
	*Trait
	Weight int `json:"weight"`
}

// TraitRarity holds nested rarity info returned from eager loading.
...
type Trait struct {
	...
	Rarity      *TraitRarity           `json:"rarity"`
